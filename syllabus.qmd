...
<p align="justify">
`MAT555E` is graduate level course aims to provide an introduction to statistical learning methods commonly used for inference and prediction. The course will harmonize statistical theory and data analysis through examples. This course aims to:
<ol> 
